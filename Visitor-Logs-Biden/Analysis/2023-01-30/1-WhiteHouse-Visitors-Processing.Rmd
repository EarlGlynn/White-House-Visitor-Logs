...
length(s)
```
This number is consistent with the [White House release statement on Jan 30, 2023](https://www.whitehouse.gov/briefing-room/disclosures/2023/01/30/october-2022-visitor-log-records-posted/).   #####

`the total number of records posted to 249,243.`
...
Note:  `sgotus` is "Second Gentleman of the United States"
