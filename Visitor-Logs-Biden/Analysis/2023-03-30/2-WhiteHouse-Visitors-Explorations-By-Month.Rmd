...
```{r}
DATA_RELEASE  <- "2023-03-30"          ##### (1/4)
```

```{r}
RANGE <- "(Jan 2021 - Dec 2022)"       ##### (2/5 - also below)
```

[December 2022 Visitor Log Records Posted, March 30, 2023](https://www.whitehouse.gov/briefing-room/disclosures/2023/03/30/december-2022-visitor-log-records-posted/)


```{r}
SOURCE <-  paste0("Source: www.whitehouse.gov/briefing-room/disclosures/2023/03/30/\n",    #####  (4/5)
                  "december-2022-visitor-log-records-posted/")                             #####  (5/5)
