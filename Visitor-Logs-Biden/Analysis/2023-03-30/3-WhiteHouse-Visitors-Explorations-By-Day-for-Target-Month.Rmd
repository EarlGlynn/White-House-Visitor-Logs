...
SOURCE <-  paste0("Source: www.whitehouse.gov/briefing-room/disclosures/2023/03/30/\n",    #####  (2/4)
                  "december-2022-visitor-log-records-posted/")                             #####  (3/4)
...
```{r TargetBidenPotusVPotusFlotus, fig.height = 4, fig.width = 8}
longFormat                                                               |>
...
```{r TargetBidenPotusStaffTourist, fig.height = 4, fig.width = 8}
longFormat                                                             |>
