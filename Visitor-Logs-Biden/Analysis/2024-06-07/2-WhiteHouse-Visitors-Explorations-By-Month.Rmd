...
```{r}
DATA_RELEASE  <- "2024-06-07"                                              ##### (1/2)
```

```{r}
RANGE <- "(Jan 2021 - Feb 2024)"                                           ##### (2/2)
```
...
```{r BidenPotusVPotusFlotus, fig.height = 4, fig.width = 11}
longFormat                                                               |>
...
```{r BidenPotusStaffTourist, fig.height = 4, fig.width = 11}
longFormat                                                             |>
