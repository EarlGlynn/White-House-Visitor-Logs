---
title: "White House Visitors - Explorations - By Month"
...
```{r}
RANGE <- "(Jan 2021 - Jan 2023)"       ##### (2/5 - also below)
```
...
SOURCE <-  paste0("Source: www.whitehouse.gov/briefing-room/disclosures/2023/04/30/\n",    #####  (4/5)
                  "january-2023-visitor-log-records-posted/")                              #####  (5/5)

stamp   <- paste0("watchdoglab.substack.com\n", format(time.1, "%Y-%m-%d"))
```       

```{r}
VISITOR_LIMIT <- 100000  # Dec 2022 - all visitors
PVF_LIMIT     <-  20000  # Dec 2022 - POTUS/VPOTUS/FLOTU visitors
```
...
longFormat                                                               |>
  ...
  labs(
        title    = paste0("White House Visitors During Biden Administration ", RANGE),
